...
# poniżej cpu_idx będzie równy nazwie pola, czyli MonitoringData-2 (a nie 1 czy 2)
# dlatego też używa się sprintf("%v%v", [cpu_idx, "-thresholdvalue"]) w celu wyprodukowanie indeksu dla Thresholdvalue (i podobnie dla Thresholdkind)
